    ...
    <section className="space-y-8">
      <div className="rounded-[2.5rem] bg-white p-6 shadow-[0_24px_80px_rgba(61,50,38,0.08)] sm:p-8">
        <div className="grid gap-6 lg:grid-cols-[0.8fr_1.2fr] lg:items-end">
          ...
          <div className="rounded-[2rem] bg-[#f8f3eb] p-4">
      ...
      <div className="grid gap-8 lg:grid-cols-[0.85fr_1.15fr]">
        ...
        <div className="rounded-[2.5rem] bg-[#f2ece2] p-6 shadow-[0_24px_80px_rgba(61,50,38,0.07)] sm:p-8">
...
function CatalogItemCard({
  ...
  return (
    <div className="rounded-[2rem] bg-white p-6 shadow-[0_18px_55px_rgba(61,50,38,0.07)]">
      ...
      <h3 className="mt-5 font-serif text-3xl leading-tight text-[#211f1b]">
        {item.title}
      </h3>
